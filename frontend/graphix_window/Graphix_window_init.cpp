...
Graphix_window::Graphix_window()
    : Graph_lib::Window({10, 10}, 1000, 750, "FIDocalcus"), unit_intr{50.0},
      ...
      scale_button{Graph_lib::Point{in_box_w + in_box_label_w - btn_w, h() - in_box_h}, btn_w,
                   in_box_h, "Scale", cb_change_unit_intr},
      scale_box{Graph_lib::Point{in_box_label_w, h() - in_box_h}, in_box_w - btn_w, in_box_h, "1:"},
      point_box{w(), h(), cb_show_points, cb_hide_points},
      new_func_button{Graph_lib::Point{border_dist, 0}, btn_w, btn_h, "New", cb_new_func},
...
void Graphix_window::init()
{
    ...
    Function_box* func_box = new Function_box{0,           cb_graphix_draw, cb_graphix_hide,
