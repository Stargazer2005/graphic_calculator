...
class Graphix_window : public Graph_lib::Window
{
  public:
    ...
    Graphix_window(Graph_lib::Point left_corner, pix_amount _width, pix_amount _height,
                   const std::string& title, pix_amount _unit_intr);
  ...
  private:
    ...
    static void cb_graphix_draw (void*, void* widget);  // enter_menu[i]->draw_graphix_button
    static void cb_graphix_hide (void*, void* widget);  // enter_menu[i]->hide_graphix_button

    static void cb_deriv_draw (void*, void* widget);  // enter_menu[i]->draw_deriv_button
    static void cb_deriv_hide (void*, void* widget);  // enter_menu[i]->draw_deriv_button
    ...
    static void cb_rem_func (void*, void* widget);  // enter_menu[i]->rem_func_button
