...
void Graphix_window::draw_deriv(size_t func_index)
{
    ...
    if (enter_menu[func_index]->is_input_valid())
        enter_menu[func_index]->set_deriv_message("(" + inputed_funcs[func_index].get_func_str() +
                                                  ")'");
...
void Graphix_window::new_func_box()
{
    ...
    Function_box* func_box = new Function_box{enter_menu.size(), cb_graphix_draw, cb_graphix_hide,
